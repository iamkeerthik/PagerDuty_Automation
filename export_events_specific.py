...
if __name__ == "__main__":
    ...
    start_date = datetime(2024, 4, 3, 0, 0)  # Start date with time
    end_date = datetime(2024, 4, 9, 23, 59)  # End date with time  # Default to the last 7 days
    ...
    for service in services:
        ...
        if service_name in specified_services:
